...
public class EmWageOfcondition {
    int random;
    int Wage_per_Hour;
    int Hour;
    ...
    EmWageOfcondition(int  Wage_per_Hour,int max_number_of_day,int max_number_of_hour){
    ...
    public static void main(String[] args) {
        ...
        EmWageOfcondition month = new EmWageOfcondition(20, 20, 100);
        month.calculate();
    }
    }
